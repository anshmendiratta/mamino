...
bind_model_data :: proc(vao: u32, vbo: u32, ebo: u32, data: []objects.Vertex, indices: []u16) {

}

bind_object_data :: proc(vao: u32, vbo: u32, ebo: u32, data: []objects.Vertex, indices: []u16) {
